...
$query = "SELECT id_categoria, designacao, preco FROM servico";
$servicos = mysqli_query($conn, $query);
?>
<!DOCTYPE html>
<html lang="pt">
<head>
...
<title>Gestão de Serviços - #Caraderica</title>
...
<nav class="sidebar d-flex flex-column">
    ...
    <ul class="nav flex-column mt-3" style="list-style: none; padding-left: 0;">
        ...
        <li class="nav-item"><a class="nav-link active" href="list.php"><i class="bi bi-scissors me-2"></i>Serviços</a></li>
...
<div class="content container-fluid">
    <header class="mb-4">
        ...
        <p>Visualize, edite ou remova serviços existentes.</p>
    </header>

    <section class="table-section">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2>Lista de Serviços</h2>
            <a href="create.php" class="btn_primary">➕ Adicionar Serviço</a>
        </div>
                    ...
                    foreach($servicos as $servico){
                        ?><tr>
                            ...
                            <td class='table-actions'>
                                <a href='view.php?id=<?= $servico['id_categoria'] ?>' class='btn_ver'>Ver</a>
                                <a href='edit.php?id=<?= $servico['id_categoria'] ?>' class='btn_editar'>Editar</a>
                                <a href='delete.php?id=<?= $servico['id_categoria'] ?>' class='btn_apagar'>Apagar</a>
                            </td>
                        </tr>
                    <?php
                    }
                } else {
                    echo "<tr><td colspan='4' class='text-center'>Nenhum serviço encontrado.</td></tr>";
                }
                ?>
                </tbody>
            </table>
